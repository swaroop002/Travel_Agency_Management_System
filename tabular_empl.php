...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        <h3><span><a href="admin_view_records.php"><i class="fas fa-arrow-left"></i></a></span> View Employees</h3>
        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <?php echo "<img src='".$rows['face']."' height=100px width=100px>"?>
                </td>
                <td>
                    <?php echo "<img src='".$rows['proof']."' height=100px width=100px>"?>
                </td>
            </tr>
            </tb>
