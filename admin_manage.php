        ...
        <div class="row">
            <div class="col-3">
                <center>
                    ...
                    <hr>
                    <ul>
                        <li> <a href="add_empl.php"> Register New Employee </a> </li>
                        <li><a href="select_empl.php"> Update/Del. Employee </a></li>
                        <li><a href="select_empl_del.php"> View Employee </a></li>
                    </ul>
                </center>
            ...
            <div class="col-3">
                <center>
                    ...
                    <hr>
                    <ul>
                        <li> <a href="add_driver.php"> Register New Driver </a> </li>
                        <li><a href="select_driver_del.php"> Update/Delete Driver </a></li>
                        <li><a href="select_driver.php"> View Driver </a></li>
                    </ul>
                </center>
            </div>
            <div class="col-3">
                <center>
                    ...
                    <hr>
                    <ul>
                        <li> <a href="add_vehicle.php"> Register New Vehicle </a> </li>
                        <li><a href="select_vehicle_del.php"> Update/Delete Vehicle  </a></li>
                        <li><a href="select_vehicle.php"> View Vehicle </a></li>
                    </ul>
                </center>
            </div>
        </div>
