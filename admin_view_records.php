...
<body>
    ...
    <div class="content">
        <h3>View Records</h3>
        <div class="row">
            <div class="col-3"><center><a href="tabular_empl.php">View Employees</a></center></div>
            <div class="col-3"><center><a href="tabular_driver.php">View Drivers</a></center></div>
            <div class="col-3"><center><a href="tabular_vehicle.php">View Vehicles</a></center></div>
        </div>
        <div class="row">
            <div class="col-3" id="lower1"><center><a href="tabular_booking.php">View Bookings</a></center></div>
            <div class="col-3" style="margin-top: 4%;"><center><a href="tabular_transaction.php">View Tr. History</a></center></div>
        </div>
    </div>
