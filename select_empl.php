...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        <h3><a href="admin_manage.php"><i class="fas fa-arrow-left"></i></a> Select Employee to Modify </h3>
        ...
        <?php
            ...
            $sql="SELECT * FROM employees  WHERE job_status='ACTIVE'";
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="update_empl.php?emp_id= <?php echo $rows['emp_id'] ;?>"> <button type="button"
                                class="butt">Update</button></a></td>

                    <td><a href="del_empl.php?emp_id= <?php echo $rows['emp_id'] ;?>"> <button type="button"
                                class="butt">Delete</button></a></td>
                </tr>
            </tbody>
        <?php
            }?>
