...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        <h3><a href="admin_sales.php"><i class="fas fa-arrow-left"></i></a> Select Driver to Pay </h3>
        ...
        <?php
            ...
            $sql="SELECT * FROM `drivers` WHERE payment_status='UNPAID' AND hire_status='HIRED'; ";
            ...
            while($rows=mysqli_fetch_array($result)){?>
                <tr>
                        ...
                        <td><a href="pay_driver.php?driver_id= <?php echo $rows['driver_id'] ;?>"> <button type="button" class="butt">Pay</button></a></td>
                </tr>
            <?php
            }?>
        </table>
