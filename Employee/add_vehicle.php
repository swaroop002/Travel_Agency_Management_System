...
if(isset($_POST["submitxd"])){
    ...
    $owner=$_POST['owner'];
    $contact=$_POST['phone']; 
    $sql="INSERT INTO `vehicles` (`veh_no`, `veh_type`, `veh_cap`, `veh_model`, `veh_issue`, `availablity`, `owner_name`, `owner_contact`, `payment_status`) VALUES ('$veh_no', '$veh_type', '$veh_cap', '$veh_model','$veh_issue', 'AVAILABLE', '$owner', '$contact', 'PAID')";
    $result=mysqli_query($conn,$sql);
    $sql1="SELECT * FROM vehicles WHERE veh_no='$veh_no';";
