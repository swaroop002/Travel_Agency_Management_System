...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        ...
        <h3><a href="admin_manage.php"><i class="fas fa-arrow-left"></i></a> Select Vehicle to View </h3>
        ...
        <?php
            ...
            while($rows=mysqli_fetch_array($result)){?>
                <tr>
                        ...
                        <td><a href="view_vehicle.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="butt">View</button></a></td>
                </tr>
            <?php
            }?>
        </table>
