...
<?php
    ...
    $sql="UPDATE drivers SET hire_status='UNHIRED' where driver_id=$id";
    $result=mysqli_query($conn,$sql);
    if($result){
        echo "<script>
...
<div class="content">
    ...
    <h3><a href="select_driver_del.php"><i class="fas fa-arrow-left"></i></a> Delete Driver</h3>
    <div class="row">
        <div class="col-11">
            ...
            <table class="table table-striped">   
                    ...
                    <form method="post">
                        <tr>
                            <td></td>
                            <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="submit" name="delete" value="Delete Driver" id="subbtn"></td>
                        </tr>
                    </form>
                    <table>
            </div>
