...
<?php
    ...
    $sql="SELECT COUNT(*) FROM `vehicles` WHERE `hire_status`='HIRED' AND `payment_status`='UNPAID';";
    ...
    $sql5="SELECT COUNT(*) FROM `drivers` WHERE `hire_status`='HIRED' AND `payment_status`='UNPAID';";
