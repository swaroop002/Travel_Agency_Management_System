...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        <h3><a href="admin_manage.php"><i class="fas fa-arrow-left"></i></a> Select Employee to View </h3>
        ...
        <?php
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="view_empl.php?emp_id= <?php echo $rows['emp_id'] ;?>"> <button type="button"
                                class="butt">View</button></a></td>
                </tr>
            </tbody>
        <?php
            }?>
