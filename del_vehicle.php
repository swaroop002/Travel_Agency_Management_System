...
<?php
    ...
    $sql="UPDATE vehicles SET hire_status='UNHIRED' where id=$id";
    $result=mysqli_query($conn,$sql);
    if($result){
        echo "<script>
...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        ...
        <h3><a href="select_vehicle_del.php"><i class="fas fa-arrow-left"></i></a> Delete Vehicle</h3>
        <div class="row">
            <div class="col-11">
                <table class="table table-striped">
                        ...
                        <tr>
                            <td></td>
                            <td><input type="submit" name="delete" value="Delete Vehicle" id="subbtn"></td>
                        </tr>
                    </form>
                    <table>
            </div>
