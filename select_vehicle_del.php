...
<a href="admin_settings.php"><i class="fas fa-cog"></i><span>Settings</span></a>
    ...
    <div class="content">
        <h3><a href="admin_manage.php"><i class="fas fa-arrow-left"></i></a></i> Select Vehicle to Update/ Delete </h3>
        ...
        <?php
            ...
            $sql="SELECT * FROM vehicles where hire_status='HIRED'";
            ...
            while($rows=mysqli_fetch_array($result)){?>
                <tr>
                        ...
                        <td><a href="update_vehicle.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="butt">Update</button></a></td>
                        <td><a href="del_vehicle.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="butt">Delete</button></a></td>
                </tr>
            <?php
            }?>
        </table>
